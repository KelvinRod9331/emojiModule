      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_antd.Input, {
            ...
            id: "emoji-input",
            style: this.props.useDefaultStyle ? {
              width: "800px"
            } : this.props.eStyle,
            value: emojiKeyInput,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.state.smileys_people.map(function (el, idx) {
          ...
          _react2.default.createElement(
            ...
            this.state.animals_nature.map(function (el, idx) {
              if (el[0].includes(emojiKeyInput)) {
                return _react2.default.createElement(
                  "span",
                  {
          ...
          _react2.default.createElement(
            ...
            this.state.food_drinks.map(function (el, idx) {
              if (el[0].includes(emojiKeyInput)) {
                return _react2.default.createElement(
                  "span",
                  {
          ...
          _react2.default.createElement(
            ...
            this.state.activity.map(function (el, idx) {
              if (el[0].includes(emojiKeyInput)) {
                return _react2.default.createElement(
                  "span",
                  {
          ...
          _react2.default.createElement(
            ...
            this.state.travel_places.map(function (el, idx) {
              if (el[0].includes(emojiKeyInput)) {
                return _react2.default.createElement(
                  "span",
                  {
          ...
          _react2.default.createElement(
            ...
            this.state.objects.map(function (el, idx) {
              if (el[0].includes(emojiKeyInput)) {
                return _react2.default.createElement(
                  "span",
                  {
          ...
          _react2.default.createElement(
            ...
            this.state.symbols.map(function (el, idx) {
              if (el[0].includes(emojiKeyInput)) {
                return _react2.default.createElement(
                  "span",
                  {
          ...
          _react2.default.createElement(
            ...
            this.state.flags.map(function (el, idx) {
              if (el[0].includes(emojiKeyInput)) {
                return _react2.default.createElement(
                  "span",
                  {
